...
HD_PWD='C:/Users/patel/OneDrive/Desktop/VLSI_PROJECT/clock_gating_FSM/clock_gating_FSM.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tb_clock_gating.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tb_clock_gating.tcl
